...
/* Лого АРХИХАБ — стилизованная буква А в виде арки на тёмном фоне */
          ...
          {navItems.filter(item => item.access).map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.count != null && (
                  <span className={cn(
                    "text-[11px] font-semibold rounded-full px-[7px] py-[1px] leading-tight",
                    isActive 
                      ? "bg-bg/15 text-bg" 
